...
--opensearch-host=${parameter["OPENSEARCH_ENDPOINT"]} \
--opensearch-port=443 \
--opensearch-index-prefix=${parameter["BRAND"]} \
...
## configure smtp ses 
bin/magento config:set system/smtp/host ${parameter["SES_ENDPOINT"]}
bin/magento config:set system/smtp/port 587
bin/magento config:set system/smtp/ssl tls
bin/magento config:set system/smtp/auth login
bin/magento config:set system/smtp/username ${parameter["SES_KEY"]}
bin/magento config:set system/smtp/password ${parameter["SES_PASSWORD"]}
