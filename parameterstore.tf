...
"CLOUDMAP_FRONTEND_SERVICE_ID" : "${aws_service_discovery_service.this["frontend"].id}",
"CLOUDMAP_ADMIN_SERVICE_ID" : "${aws_service_discovery_service.this["admin"].id}",
"CLOUDMAP_VARNISH_SERVICE_ID" : "${aws_service_discovery_service.this["varnish"].id}",
"CLOUDMAP_MARIADB_SERVICE_ID" : "${aws_service_discovery_service.this["mariadb"].id}",
