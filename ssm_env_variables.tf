...
"VERSION" : "${var.magento["version"]}",
"DOMAIN" : "${var.magento["domain"]}",
"BRAND" : "${var.magento["brand"]}",
"PHP_USER" : "php-${var.magento["brand"]}",
"ADMIN_EMAIL" : "${var.magento["admin_email"]}",
"ADMIN_LOGIN" : "${var.magento["admin_login"]}",
"ADMIN_FIRSTNAME" : "${var.magento["admin_firstname"]}",
"ADMIN_LASTNAME" : "${var.magento["admin_lastname"]}",
...
"COMPOSER_USER" : "${var.magento["composer_user"]}",
"COMPOSER_PASS" : "${var.magento["composer_pass"]}"
}
EOF
