...
# # ---------------------------------------------------------------------------------------------------------------------#
resource "aws_cloudwatch_event_rule" "eventbridge_rule_codecommit_main" {
...
# # ---------------------------------------------------------------------------------------------------------------------#
resource "aws_cloudwatch_event_target" "eventbridge_target_codecommit_main" {
  rule      = aws_cloudwatch_event_rule.eventbridge_rule_codecommit_main.name
