...
- action: "aws:runShellScript"
  ...
  inputs:
    ...
    - |-
      ...
      su ${var.app["brand"]} -s /bin/bash -c "bin/magento config:show web/secure/enable_hsts"
      su ${var.app["brand"]} -s /bin/bash -c "bin/magento config:show web/secure/enable_upgrade_insecure"
      ## enable eav cache
